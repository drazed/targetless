...
targetless.ui.close = iup.stationbutton{title="Click To Close", expand="HORIZONTAL", action=function(self) HideDialog(targetless.ui.dlg) end}
...
targetless.ui.dlg = iup.dialog{
    iup.vbox{
        iup.fill{},
        iup.label{title="", alignment="ACENTER", expand="HORIZONTAL", font=Font.H3},
        iup.fill{},
        iup.hbox{
            iup.fill{},
            iup.pdarootframe{
...
--                        targetless.ui.optionsbutton,
    ...
    menubox="NO",
    topmost="YES",
    hide_cb=function(self) FadeStop(targetless.ui.logintext) targetless.ui.logintext.alpha = 0 end,
}
